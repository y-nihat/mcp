    ...
    async with stdio_client(server_params) as (read, write):
        async with ClientSession(read, write) as session:
            ...
            if gblocks:
                ...
                # Try to parse JSON string; otherwise keep raw
                try:
                ...
                greeting = getattr(greet_resp, "text", None) or str(greet_resp)

            print(f"Output from greet tool: {greeting}")
            ...
            if ablocks:
                ...
                try:
                    ...
                    # try eval fallback (not recommended but robust for simple reprs)
                    try:
                        obj = eval(atext)
